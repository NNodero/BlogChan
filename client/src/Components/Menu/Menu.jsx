    ...
    <div className={s.maincontainer}>
        ...
        {post.map((data)=>(
            <div className={s.content} key={data.id}>
                <div className={s.imgbox}>   {data.img? <img src={require(`../../Assests/Images/${data.img}`)} alt='mainimg' className={s.img}/> : <img src={require(`../../Assests/Images/noimage.jpg`)} alt='mainimg' className={s.img}/> }</div>
